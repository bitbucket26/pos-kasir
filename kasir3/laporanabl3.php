                                ...
                                <table class="DataTable table-striped" id="Tables" style="width: 100%;">
                                    ...
                                    <?php 
                                        ...
                                        if(isset($_GET['filter'])) {
                                            $daritgl = mysqli_real_escape_string($koneksi, $_GET['daritgl']);
                                            $sampaitgl = mysqli_real_escape_string($koneksi, $_GET['sampaitgl']);
                                            $data = mysqli_query($koneksi,"SELECT * from ablkasir3 where tanggal BETWEEN '$daritgl' AND '$sampaitgl'");
                                        }else{
                                            $data = mysqli_query($koneksi,"SELECT * from ablkasir3");
                                        }
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                <!-- <a href="updateablkasir3.php?id=<?php echo $d['nomor']; ?>" type="button" data-toggle="modal" class="btn btn-primary btn-md" data-target="#myModal<?php echo $d['nomor']; ?>">
                                    ...
                                    <!-- <div class="modal fade" id="myModal<?php echo $d['nomor']; ?>" role="dialog">
                                            ...
                                            <form action="updateablkasir3.php" method="GET">

                                                <?php
                                                include '../koneksi.php';
                                                $id = $d['nomor']; 
                                                $query_edit = mysqli_query($koneksi,"SELECT * FROM ablkasir3 WHERE nomor='$id'");
