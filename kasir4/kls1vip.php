...
<head>
    ...
    <title>BPJS Kelas 1 Naik VIP</title>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">BPJS - KELAS 1 NAIK VIP</h6>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="row" style="width: 100%; margin-left: 1px; padding: 10px 10px;">
                                                    ...
                                                    <label class="labeldata" for="">Real Coast</label>
                                                        ...
                                                        <input type="number" name="realcoast" class="form-control" id="1viprealcoast" onchange="jumlah1vip()" required>

                                                    <label class="labeldata" for="">Tarif INA CBG Kelas 1 (Enter)</label>
                                                    ...
                                                    <label class="labeldata" for="">TOTAL</label>
                                                        ...
                                                        <input type="text" name="total" class="form-control" id="1viptotal" readonly>
                                                    ...
                                                    <label class="labeldata" for="">Terbilang</label>           
                                                        ...
                                                        <input type="text" name="nota1" id="nota11vip" class="form-control" onkeypress="jumlah1vip()" readonly hidden>
                                                    
                                                        <input type="text" name="nota2" id="nota21vip" class="form-control" onkeypress="jumlah1vip()" readonly hidden>
    ...
    <script>
        ...
        var input = document.getElementById("1vipkls1");
        input.addEventListener("keypress", function(event) {
        if (event.key === "Enter") {
           event.preventDefault();
              const nilai = document.getElementById("1viptotal").value;
