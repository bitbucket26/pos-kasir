...
<!-- End of Footer -->
    ...
    <script>
        ...
        var input = document.getElementById("2vipkls2");
        input.addEventListener("keypress", function(event) {
        if (event.key === "Enter") {
           event.preventDefault();
              const nilai = document.getElementById("2viptotal").value;
              let hasil1 = terbilang(nilai) + "Rupiah";
    ...
    <!-- <script>
        ...
        var input = document.getElementById("2viptotal");
        input.addEventListener("keypress", function(event) {
        if (event.key === "Enter") {
           event.preventDefault();
              const nilai = document.getElementById("2viptotal").value;
