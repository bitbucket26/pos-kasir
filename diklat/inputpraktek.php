...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Praktek</h6>
    </div>
    <div class="card-body">
                            ...
                            <div class="col">
                                ...
                                <label class="labeldata">Kategori Pendidikan</label>
                                            <select name="pendidikan" class="form-control" id="pendidikan" onchange="nilaik(this.value)" required>
                                                ...
                                                <option value="SMU NON KESEHATAN">SMU NON KESEHATAN</option>
                                                <option value="SMU KESEHATAN / SEDERAJAT">SMU KESEHATAN / SEDERAJAT</option>
                                                <option value="D III NON KESEHATAN">D III NON KESEHATAN</option>
                                                <option value="D III KESEHATAN">D III KESEHATAN</option>
                                                <option value="D IV / S1 NON KESEHATAN">D IV / S1 NON KESEHATAN</option>
                                                <option value="D IV / S1 KESEHATAN">D IV / S1 KESEHATAN</option>
                                    ...
                                    <input type="number" name="nilai" class="form-control" id="nilai" readonly>				
                                            <script>
                                                        function nilaik(e) {
                                                            ...
                                                            console.log(e)
                                                            // minimal 2 = om
                                                            if (e == "SMU NON KESEHATAN"){
                                                            $("#nilai").val(10000);
                                                            } else if(e == "SMU KESEHATAN / SEDERAJAT"){
                                                            $("#nilai").val(12500);
                                                            } else if(e == "D III NON KESEHATAN"){
                                                            $("#nilai").val(15000);
                                                            } else if(e == "D III KESEHATAN"){
                                                            $("#nilai").val(17500);
                                                            } else if(e == "D IV / S1 NON KESEHATAN"){
                                                            $("#nilai").val(17500);
                                                            } else if(e == "D IV / S1 KESEHATAN"){
                                                            $("#nilai").val(20000);
                                                            } else if(e == "PROFESI"){
                                                            $("#nilai").val(20000);
                                                            } else if(e == "S2 / SEDERAJAT"){
                                                            $("#nilai").val(25000);
                                                            } else if(e == "MAHASISWA ASING 2"){
                                                            $("#nilai").val(2000000);
                                                            } else {
                                                            $("#nilai").val(0);
                                                            }
