...
if (mysqli_connect_error()){
    ...
    {
        $query = mysqli_query($koneksi,"SELECT sum(total) as total from praktek where YEAR(tanggalpembayaran)='$thn'");
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                $query_sesi = mysqli_query($koneksi,"SELECT sum(total) as total from praktek where (tanggalpembayaran)= '$day_sesi'");
                        ...
                        <div class="card shadow mb-4">
                            <?php
                                ...
                                if (empty($a)) {
                                    ...
                                    $query = mysqli_query($koneksi,"SELECT sum(total) as total from praktek where DAY(tanggalpembayaran)= '$day' group by date(tanggalpembayaran)");
                                    $row = $query->fetch_array();
                                    $totals[] = $row['total'];
                                    // echo json_encode($total);

                                    $query1 = mysqli_query($koneksi,"SELECT sum(total) as total from praktek where DAY(tanggalpembayaran)= '$day1' group by date(tanggalpembayaran)");
                                    $row1 = $query1->fetch_array();
                                    $total1[] = $row1['total'];

                                    $query2 = mysqli_query($koneksi,"SELECT sum(total) as total from praktek where DAY(tanggalpembayaran)= '$day2' group by date(tanggalpembayaran)");
                                    $row2 = $query2->fetch_array();
                                    $total2[] = $row2['total'];

                                    $query3 = mysqli_query($koneksi,"SELECT sum(total) as total from praktek where DAY(tanggalpembayaran)= '$day3' group by date(tanggalpembayaran)");
                                    $row3 = $query3->fetch_array();
                                    $total3[] = $row3['total'];

                                    $query4 = mysqli_query($koneksi,"SELECT sum(total) as total from praktek where DAY(tanggalpembayaran)= '$day4' group by date(tanggalpembayaran)");
                                    $row4 = $query4->fetch_array();
                                    $total4[] = $row4['total'];

                                    $query5 = mysqli_query($koneksi,"SELECT sum(total) as total from praktek where DAY(tanggalpembayaran)= '$day5' group by date(tanggalpembayaran)");
                                    $row5 = $query5->fetch_array();
                                    $total5[] = $row5['total'];

                                    $query6 = mysqli_query($koneksi,"SELECT sum(total) as total from praktek where DAY(tanggalpembayaran)= '$day6' group by date(tanggalpembayaran)");
                                    $row6 = $query6->fetch_array();
                                    $total6[] = $row6['total'];

                                    $query7 = mysqli_query($koneksi,"SELECT sum(total) as total from praktek where DAY(tanggalpembayaran)= '$day6' group by date(tanggalpembayaran)");
                            ...
                            <div class="card-body">
                                <?php
                                    ...
                                    $result = mysqli_query($koneksi,"select year(tanggalpembayaran) as year, month(tanggalpembayaran) as month, sum(total) as total
                                                                    from praktek group by year(tanggalpembayaran), month(tanggalpembayaran)");
                                ?>
