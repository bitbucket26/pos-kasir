...
<!-- Input Data -->
<form action="simpanlainnya.php" method="post">
<?php
    include "../koneksi.php";
    ...
    $sql = mysqli_query($koneksi, "select max(nomor) as maxID from adminlainnya");
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Diklat Lainnya</h6>
    </div>
    <div class="card-body">
                    ...
                    <div class="card">
                        <div class="row" style="padding: 10px 10px;">
                            ...
                            <div class="row g-2">
                                ...
                                <label class="labeldata">Nama Kegiatan</label>
                            ...
                            <div class="col">
                                ...
                                <div class="row g-2">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating">
                                            <label for="floatingInputGrid" >Jumlah Hari</label>
                                            <input type="number" class="form-control"  name="jumlahhari" id="jumlahhari" required>    
                                            </div>
                                        </div>	
                                ...
                                <script>
                                                function totale(){
                                                    var a = document.getElementById("jumlahpeserta").value;
                                                    var b = document.getElementById("jumlahhari").value;
                                                    var c = document.getElementById("biaya").value;
                                                    var d = parseInt(a) * parseInt(b) * parseInt(c);
                                                    document.getElementById("total").value = (d);
                                                }
                                            </script>
                                <label for="floatingInputGrid" style="color: red;">Biaya (Enter)</label>
                                    <input type="number" class="form-control" style="border:2px solid Tomato;" name="biaya" id="biaya" onkeypress="totale()"required>
...
<br>
    ...
    <script>
        ...
        var input = document.getElementById("biaya");
