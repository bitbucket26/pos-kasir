        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php 
                    ...
                    mysqli_query($koneksi, "delete from abladmin where tanggal like '$tahun1'")
                ...
                ?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Ambulance</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            if(isset($_GET['filter'])) {
                                                $daritgl = mysqli_real_escape_string($koneksi, $_GET['daritgl']);
                                                $sampaitgl = mysqli_real_escape_string($koneksi, $_GET['sampaitgl']);
                                                $data = mysqli_query($koneksi,"SELECT * from abladmin where tanggal BETWEEN '$daritgl' AND '$sampaitgl'");
                                            }else{
                                                $data = mysqli_query($koneksi,"SELECT * from abladmin");
                                            }
