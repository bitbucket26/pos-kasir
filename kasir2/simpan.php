...
// menginput data ke database
  $sql = "INSERT INTO kasir2 VALUES('$iduser','$nomornota','$nomorsep','$nomormedrec','$namapasien','$alamat','$ruangperawatan','$hakrawatkelas','$mulaitanggal','$sampaitanggal','$dirawatkelas','$yangmembayar','$yangmenerima','$tanggalbayar','$realcoastbpjs','$ditanggungjr','$realcoast','$tarifkelas1','$tarifkelas2','$total','$nota1','$nota2','$bilang','$kategori')";
