...
<head>
    ...
    <title>KEL.KARYAWAN Kelas 1 Naik VIP</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">KEL.KARYAWAN - KELAS 1 NAIK VIP</h6>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="row" style="width: 100%; margin-left: 1px; padding: 10px 10px;">
                                                    ...
                                                    <label class="labeldata" for="">Tarif INA CBG Kelas 1 (Enter)</label>
                                                        ...
                                                        <input type="number" name="tarifkelas1" class="form-control" id="tr1kry1vip" onkeypress="jumlahkyw1vip()" required>
