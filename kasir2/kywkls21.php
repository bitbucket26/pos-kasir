...
<head>
    ...
    <title>KARYAWAN Kelas 2 Naik Kelas 1</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">KARYAWAN - KELAS 2 NAIK KELAS 1</h6>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="row" style="width: 100%; margin-left: 1px; padding: 10px 10px;">
                                                    ...
                                                    <label class="labeldata" >Tarif INA CBG Kelas 1</label>
                                                        ...
                                                        <input type="number" name="tarifkelas1" class="form-control" id="kyw21kls1" onchange="kywjumlah21()" required>

                                                    <label class="labeldata" style="color: red;">Tarif INA CBG Kelas 2 (Enter)</label>

                                                        <input type="number" style="border:2px solid Tomato;" name="tarifkelas2" class="form-control" id="kyw21kls2" onkeypress="kywjumlah21()" required>

                                                    <label class="labeldata" >TOTAL</label>

                                                        <input type="text" name="total" class="form-control" id="kyw21total" >
                                                    
                                                    <label class="labeldata" >Terbilang</label>           

                                                        <textarea type="text" name="bilang" class="form-control" id="kyw21terbilang" required></textarea>
                                                    
                                                        <input type="text" name="nota1" id="kywnota121" class="form-control" onkeypress="kywjumlah21()" readonly hidden>
                                                    
                                                        <input type="text" name="nota2" id="kywnota221" class="form-control" onkeypress="kywjumlah21()" readonly hidden >
                                                    ...
                                                    <input type="text" name="kategori" id="kategori" class="form-control" value="kyw21" hidden>
                                                        <br>
                                            </div>
...
<!-- End of Footer -->
    ...
    <script>
        ...
        var input = document.getElementById("kyw21kls2");
        input.addEventListener("keypress", function(event) {
        if (event.key === "Enter") {
           event.preventDefault();
              const nilai = document.getElementById("kyw21total").value;
              let hasil = terbilang(nilai) + "Rupiah";
              document.getElementById("kyw21terbilang").value = hasil;
        }
        });
    </script>
    <script>
        ...
        var input = document.getElementById("kyw21total");
        input.addEventListener("keypress", function(event) {
        if (event.key === "Enter") {
           event.preventDefault();
              const nilai = document.getElementById("kyw21total").value;
