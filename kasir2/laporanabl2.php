                            ...
                            <div class="card-body">
                                <table class="DataTable table-striped" id="Tables" style="width: 100%;">
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                <a href="updateablkasir2.php?id=<?php echo $d['nomor']; ?>" type="button" data-toggle="modal" class="btn btn-primary btn-md" data-target="#myModal<?php echo $d['nomor']; ?>">
                                    ...
                                    <div class="modal fade" id="myModal<?php echo $d['nomor']; ?>" role="dialog">
                                            ...
                                            <form action="updateablkasir2.php" method="GET">
