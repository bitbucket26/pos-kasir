...
<head>
    ...
    <title>JR Kelas 2 Naik VIP</title>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">JR- KELAS 2 NAIK VIP</h6>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="row" style="width: 100%; margin-left: 1px; padding: 10px 10px;">
                                                    ...
                                                    <label class="labeldata" >Ditanggung JR</label>
                                                        ...
                                                        <input type="number" name="ditanggungjr" class="form-control" id="tanggungjr2vip" onchange="jumlahjr2vip()" required>

                                                    <label class="labeldata" >Real Coast</label>

                                                        <input type="number" name="realcoast" class="form-control" id="rcjr2vip" onchange="jumlahjr2vip()" readonly>
                                                    ...
                                                    <label class="labeldata" style="color: red;">Tarif INA CBG Kelas 2 (Enter)</label>
                                                        ...
                                                        <input type="number" style="border:2px solid Tomato;" name="tarifkelas2" class="form-control" id="jrkls22vip" onkeypress="jumlahjr2vip()" required>
                                                    ...
                                                    <label class="labeldata" >Terbilang</label>           
                                                        ...
                                                        <input type="text" name="iduser" id="iduser" class="form-control" value="6" hidden>
    ...
    <script>
        ...
        var input = document.getElementById("jrkls22vip");
        input.addEventListener("keypress", function(event) {
        if (event.key === "Enter") {
           event.preventDefault();
              const nilai = document.getElementById("jr2viptotal").value;
              let hasil = terbilang(nilai) + "Rupiah";
              document.getElementById("2vipterbilang").value = hasil;
        }
        });
    </script>
    <script>
        ...
        var input = document.getElementById("jr2viptotal");
        input.addEventListener("keypress", function(event) {
        if (event.key === "Enter") {
           event.preventDefault();
              const nilai = document.getElementById("jr2viptotal").value;
