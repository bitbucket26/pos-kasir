...
// menginput data ke database
  $sqlabl = "INSERT INTO ablkasir1 VALUES('$nomor','$tanggal','$nama','$alamatktp','$alamattujuan','$perawatpendamping','$nilai','$perawat','$ruangan','$supir','$jaraktempuh','$yangmembayar','$total','$kasir','$bilang')";
