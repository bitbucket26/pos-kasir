...
if (mysqli_connect_error()){
    ...
    {
        $query = mysqli_query($koneksi,"SELECT sum(total) as total from adminpraktek where YEAR(tanggalpembayaran)='$thn'");
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                $query_sesi = mysqli_query($koneksi,"SELECT sum(total) as total from adminpraktek where (tanggalpembayaran)= '$day_sesi'");
                            ...
                            <div class="card-body">
                                <?php
                                    ...
                                    $result = mysqli_query($koneksi,"select year(tanggalpembayaran) as year, month(tanggalpembayaran) as month, sum(total) as total
                                                                    from adminpraktek group by year(tanggalpembayaran), month(tanggalpembayaran)");
                                ?>
